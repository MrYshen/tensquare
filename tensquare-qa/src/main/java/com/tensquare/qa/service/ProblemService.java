...
public class ProblemService {
	...
	public Page<Problem> newlist(String labelId, int rows, int page){

		Pageable pageable = PageRequest.of(page-1, rows);
		return this.problemDao.newlist(labelId, pageable);
	}

	public Page<Problem> hotlist(String labelId, int rows, int page){

		Pageable pageable = PageRequest.of(page-1, rows);
		return this.problemDao.hotlist(labelId, pageable);
	}

	public Page<Problem> waitlist(String labelId, int rows, int page){
